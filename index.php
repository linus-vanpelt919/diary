...
// $getCategoryNames = getCategoryName($d_id);
//表示件数
$listSpan = 4;
//先頭を算出
$currentMinNum = (($currentPageNum-1)*$listSpan);
//
$dbPageData = getPageList($currentMinNum,$category,$date);
        ...
        <div class="container">
          ...
          <div class="main-container">
            ...
            <div class="category-container">
              <span class="category-bgColor"><?php echo sanitize($val['create_date']); ?> <a href="index.php?c_id=<?php echo $val['category_id']; ?>"><?php echo $val['name']; ?></a></span>
            </div>
